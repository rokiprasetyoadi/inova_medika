...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Feb 2022 pada 15.49
...
(6, '3509191205610001', 'Doni Erdiansah', 'L', '1999-06-01', '089654789321', 'Balung', 4, 'doni', 'f4cc399f0effd13c888e310ea2cf5399', '2022-02-11 20:50:07', '2022-02-11 21:16:18', 'Roki Prasetyo Adi'),
(9, '3509196542650001', 'Sauqia El nino', 'L', '2001-06-14', '085123654756', 'Ajung', 1, 'sauqi', 'e10adc3949ba59abbe56e057f20f883e', '2022-02-11 21:18:02', '0000-00-00 00:00:00', '');
...
--
ALTER TABLE `dtl_transaksi_obat`
  MODIFY `dtl_obat_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `dtl_transaksi_tindakan`
--
ALTER TABLE `dtl_transaksi_tindakan`
  MODIFY `dtl_tindakan_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pendaftaran_pasien`
  MODIFY `pp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `transaksi`
  MODIFY `transaksi_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
